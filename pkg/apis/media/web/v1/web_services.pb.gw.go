...
/*
Package webv1 is a reverse proxy.
...
var filter_WebService_ListTorrentRef_0 = &utilities.DoubleArray{Encoding: map[string]int{}, Base: []int(nil), Check: []int(nil)}

func request_WebService_ListTorrentRef_0(ctx context.Context, marshaler runtime.Marshaler, client WebServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq ListTorrentRefRequest
	var metadata runtime.ServerMetadata

	if err := req.ParseForm(); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_WebService_ListTorrentRef_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}

	msg, err := client.ListTorrentRef(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err
}

func local_request_WebService_ListTorrentRef_0(ctx context.Context, marshaler runtime.Marshaler, server WebServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq ListTorrentRefRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := server.ListTorrentRef(ctx, &protoReq)
	return msg, metadata, err
}
...
var filter_WebService_SearchTorrentRef_0 = &utilities.DoubleArray{Encoding: map[string]int{}, Base: []int(nil), Check: []int(nil)}

func request_WebService_SearchTorrentRef_0(ctx context.Context, marshaler runtime.Marshaler, client WebServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq SearchTorrentRefRequest
	var metadata runtime.ServerMetadata

	if err := req.ParseForm(); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_WebService_SearchTorrentRef_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}

	msg, err := client.SearchTorrentRef(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err
}

func local_request_WebService_SearchTorrentRef_0(ctx context.Context, marshaler runtime.Marshaler, server WebServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq SearchTorrentRefRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := server.SearchTorrentRef(ctx, &protoReq)
	return msg, metadata, err
}
...
func RegisterWebServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server WebServiceServer) error {
	mux.Handle("GET", pattern_WebService_ListTorrentRef_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		ctx, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/media.web.v1.WebService/ListTorrentRef", runtime.WithHTTPPathPattern("/torrents"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_WebService_ListTorrentRef_0(ctx, inboundMarshaler, server, req, pathParams)
	...
	mux.Handle("GET", pattern_WebService_SearchTorrentRef_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		var err error
		ctx, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/media.web.v1.WebService/SearchTorrentRef", runtime.WithHTTPPathPattern("/torrents/search"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_WebService_SearchTorrentRef_0(ctx, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
		...
		forward_WebService_SearchTorrentRef_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
	})
...
func RegisterWebServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client WebServiceClient) error {
	mux.Handle("GET", pattern_WebService_ListTorrentRef_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		var err error
		ctx, err = runtime.AnnotateContext(ctx, mux, req, "/media.web.v1.WebService/ListTorrentRef", runtime.WithHTTPPathPattern("/torrents"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_WebService_ListTorrentRef_0(ctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
	...
	mux.Handle("GET", pattern_WebService_SearchTorrentRef_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		var err error
		ctx, err = runtime.AnnotateContext(ctx, mux, req, "/media.web.v1.WebService/SearchTorrentRef", runtime.WithHTTPPathPattern("/torrents/search"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_WebService_SearchTorrentRef_0(ctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
