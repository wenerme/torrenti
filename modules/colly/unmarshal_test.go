...
var (
	basicTestData        = []byte(`<ul><li class="x">list <span>item</span> 1</li><li>list item 2</li><li>3</li></ul>`)
	nestedTestData       = []byte(`<div><p>a</p><div><p>b</p><div><p>c</p></div></div></div>`)
	pointerSliceTestData = []byte(`<ul class="object"><li class="info">Information: <span>Info 1</span></li><li class="info">Information: <span>Info 2</span></li></ul>`)
)
